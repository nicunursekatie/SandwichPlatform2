...
import { sendDriverAgreementNotification } from "./sendgrid.js";
import { messageNotificationRoutes } from "./routes/message-notifications.js";
import googleSheetsRoutes from "./routes/google-sheets.js";
import { setupCleanMessagingRoutes } from "./routes/clean-messaging.js";
...
import { VersionControl } from "./middleware/version-control.js";
import { BackupManager } from "./operations/backup-manager.js";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/driver-agreements", async (req, res) => {
    try {
      ...
      const { sendDriverAgreementNotification } = await import("./sendgrid.js");
  ...
  app.post("/api/google-sheets/sync-entry", async (req, res) => {
    try {
      ...
      const { GoogleSheetsSyncService } = await import("./google-sheets-sync.js");
